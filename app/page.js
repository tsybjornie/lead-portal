        ...
        <div style={{
          ...
          <div style={{ maxWidth: '600px' }}>
            ...
            <p style={{
              ...
              Get matched with 3 {market === 'SG' ? 'interior designers' : 'Malaysia renovation firms'} who fit your budget, style, and working preferences.
            </p>
            <p style={{
              fontSize: '1rem',
              lineHeight: '1.9',
              ...
              No endless browsing. No guesswork. Just 3 pre-qualified {market === 'SG' ? 'designers' : 'contractors'} matched to how you actually work — in 24 hours.
            </p>
          ...
          <section style={{
            ...
            <div style={{
              ...
              <h2 style={{
                ...
                Popular {market === 'SG' ? 'Design Styles' : 'Malaysia Styles'}
              </h2>
              ...
              <p style={{
                ...
                Find {market === 'SG' ? 'designers' : 'contractors'} who specialize in these styles
              </p>
            </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Form follows function. Clean geometry and honest materials.
                          </p>
                        </div>
                      </div>

                      {/* Style Card 2 - Modern Luxury */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Organic curves and refined craftsmanship inspired by nature.
                          </p>
                        </div>
                      </div>

                      {/* Style Card 3 - Japanese Zen */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Japanese folk craft celebrating natural handmade beauty.
                          </p>
                        </div>
                      </div>

                      {/* Style Card 4 - Industrial */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Raw concrete and exposed structure. Honest materiality.
                          </p>
                        </div>
                      </div>

                      {/* Style Card 5 - Art Deco */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Glamorous, geometric patterns with opulent details.
                          </p>
                        </div>
                      </div>

                      {/* Style Card 6 - Tropical Resort */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Sun-drenched spaces with arched openings and textured plaster.
                          </p>
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Straits Chinese heritage with ornate tiles and vibrant colors.
                          </p>
                        </div>
                      </div>

                      {/* MY Card 2 - Tropical Modernism */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Southeast Asian modernism with natural ventilation and openness.
                          </p>
                        </div>
                      </div>
                      ...
                      <div style={{
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Japanese minimalism meets Scandinavian warmth and functionality.
                          </p>
                        </div>
                      </div>

                      {/* MY Card 4 - Mid-Century Modern */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Tapered legs, organic shapes, and warm teak tones.
                          </p>
                        </div>
                      </div>

                      {/* MY Card 5 - Colonial Revival */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            British Malaya heritage with high ceilings and verandahs.
                          </p>
                        </div>
                      </div>

                      {/* MY Card 6 - Scandinavian Modern */}
                      <div style={{
                        minWidth: '350px',
                        background: 'rgba(255, 255, 255, 0.05)',
                        borderRadius: '8px',
                        ...
                        <div style={{ padding: '1.5rem' }}>
                          ...
                          <p style={{
                            ...
                            Light wood, hygge comfort, and functional simplicity.
                          </p>
                        </div>
                      </div>
                    </>
              ...
              <div style={{
                ...
                <div style={{ flex: '1 1 220px', maxWidth: '280px', textAlign: 'center' }}>
                  ...
                  <h3 style={{
                    ...
                    marginBottom: '0.75rem',
                    color: 'var(--primary-dark)'
                  }}>We Match You with 3 Firms</h3>
                  <p style={{ color: 'var(--text-light)', fontSize: '0.85rem' }}>
                    Our team personally reviews your preferences and connects you with exactly 3 pre-qualified designers
                  </p>
                  <p style={{
                    fontSize: '0.8rem',
                    color: 'var(--accent)',
                    ...
                    Why 3? Not too few (limited choice), not too many (decision paralysis). Just right.
                  </p>
                </div>
