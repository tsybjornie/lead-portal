            ...
            <div className="container" style={{ maxWidth: '900px' }}>
                ...
                <section style={{
                    ...
                    <p style={{ fontWeight: 600, marginBottom: '1rem' }}>
                        ROOF makes <strong>NO GUARANTEES</strong> regarding:
                    </p>
                ...
                <section style={{ marginBottom: '3rem' }}>
                    ...
                    <p style={{ fontWeight: 600, marginBottom: '1rem' }}>
                        ROOF does <strong>NOT</strong> handle renovation payments:
                    </p>
                    ...
                    <div style={{
                        ...
                        <p style={{
                            ...
                            ROOF has no visibility into, control over, or responsibility for these transactions.
                        </p>
                    </div>
                </section>
                ...
                <section style={{ marginBottom: '3rem' }}>
                    ...
                    <div style={{
                        ...
                        <ol style={{ marginLeft: '1.5rem' }}>
                            <li style={{ marginBottom: '0.75rem' }}>
                                ROOF is <strong>not liable</strong> for any losses, damages, or costs arising from:
                ...
                <section>
                    ...
                    <p>
                        By using ROOF, you acknowledge that you have read, understood, and accept these disclaimers and limitations.
                    ...
                    <div style={{
                        ...
                        <p style={{ marginBottom: '0.5rem' }}>
                            ✓ ROOF is an <strong>introduction service only</strong>
                        </p>
                        <p style={{ marginBottom: '0.5rem' }}>
                    ...
                    <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem' }}>
                        <Link href={`/${market}/legal/trust`} className="btn btn-secondary">
                            Trust & Transparency
                        </Link>
                        <Link href={`/${market}/legal/roles`} className="btn btn-secondary">
