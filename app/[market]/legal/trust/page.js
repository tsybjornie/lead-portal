...
export const metadata = {
    title: 'Trust & Transparency - ROOF',
    description: 'How ROOF works: our match-first approach, quality standards, and commitment to transparency.'
};
        ...
        <div style={{ background: 'white', padding: '4rem 0' }}>
            <div className="container" style={{ maxWidth: '900px' }}>
                ...
                <section style={{ marginBottom: '3rem' }}>
                    <h2>How ROOF Works</h2>
                    <p>
                        ROOF is an <strong>introduction service</strong> that connects homeowners with qualified renovation firms in Singapore.
