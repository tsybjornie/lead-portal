...
export const metadata = {
    title: 'Roles & Responsibilities - ROOF',
    description: 'Understanding the roles of homeowners, firms, and ROOF in the renovation process.'
};
        ...
        <div style={{ background: 'white', padding: '4rem 0' }}>
            <div className="container" style={{ maxWidth: '900px' }}>
                ...
                <p style={{ fontSize: '1.1rem', marginBottom: '3rem', color: 'var(--text-light)' }}>
                    ROOF is an introduction service. Understanding each party&apos;s role ensures realistic expectations and successful outcomes.
                </p>
                ...
                <section style={{ marginBottom: '3rem' }}>
                    ...
                    <p>
                        ROOF operates as a <strong>lead generation and introduction platform</strong>.
                        This means:
                    </p>
                ...
                <section>
                    ...
                    <p style={{
                        ...
                        <strong>Important:</strong> ROOF cannot mediate disputes, recover payments, or compel firms to complete work.
                    ...
                    <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem' }}>
                        ...
                        <Link href={`/${market}/legal/disclaimers`} className="btn btn-secondary">
                            Disclaimers
                        </Link>
                    </div>
                </section>
