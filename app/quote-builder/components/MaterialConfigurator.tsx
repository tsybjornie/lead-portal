...
export const CABINET_COMPONENTS: Record<string, CabinetComponent[]> = {
    ...
    'Surface Finish': [
        ...
        },
        {
            ...
            description: 'Thin slice of real wood (0.53mm) bonded to plywood/MDF. Natural grain variation. Brands: Decowood, Shinnoki.',
            cost: '$1025/sqm',
        ...
        },
        {
            ...
            cost: '$1230/sqm (natural), $512 (synthetic)',
    ...
    'Hardware': [
        ...
        },
        {
            ...
            cost: '$1560/pc (Blum Aventos: $100180/set)',
    ...
    'Doors': [
        ...
        },
        {
            ...
            description: 'Ultra-thin aluminium frame (1520mm visible edge) with large glass panels. Maximises glass area, minimises frame visibility. Trending for kitchen/balcony separation.',
            cost: '$6001,500/panel',
    ...
    'Countertops': [
        ...
        {
            name: 'Sintered Stone (Dekton/Laminam)',
            description: 'Ultra-compact surface (Dekton, Laminam, Neolith). Heat-proof, scratch-proof, UV-stable. 1220mm thick slabs.',
            cost: '$150300/lft',
    ...
    'Electrical / LEW': [
        ...
        },
        {
            ...
            cost: '$2,5005,000 (3-rm), $4,0008,000 (5-rm)',
        ...
        },
        {
            ...
            cost: '$200500 (LEW fee for SLD)',
            pros: 'Legally required, ensures safety compliance, formal SP Group approval',
            cons: 'Takes 12 weeks for approval, must engage LEW separately from contractor',
            tier: 'standard',
        },
        {
    ...
    'Door Panel Profiles': [
        ...
        },
        {
            ...
            cost: '+$40200/door (depends on glass type)',
        ...
        },
        {
            ...
            cost: '+$2050/door (aluminium channel)',
    ...
    'Ceiling Types': [
        {
            ...
            cost: '$58/sqm (flat), $815/sqm (L-box/pelmet)',
        ...
        },
        {
            ...
            cost: '$25/sqm (cleaning + painting only)',
    ...
    'Flooring': [
        ...
        },
        {
            ...
            cost: '$48/sqm (supply), $46/sqm (install)',
        ...
        },
        {
            ...
            cost: '$315/sqm (supply varies wildly)',
    ...
    'Wall Finishes': [
        {
            ...
            cost: '$1.503/sqm (2 coats, labour incl.)',
        ...
        },
        {
            ...
            description: 'Thin cementitious coating (23mm) applied over existing surfaces. Creates industrial concrete-look finish. Seamless, no grout.',
            cost: '$1225/sqm',
    ...
    'Waterproofing': [
        {
            ...
            description: 'Cement-based coating mixed with acrylic binder. Brush-applied in 23 coats. Standard for HDB/condo bathroom floors + walls. Brands: Mapei, Sika.',
            cost: '$48/sqm (material + labour)',
    ...
    'Window Treatments': [
        {
            ...
            cost: '$815/m (track), $1550/m (fabric)',
    ...
    'Partitions': [
        ...
        },
        {
            ...
            description: 'Tempered glass panels (1012mm) in aluminium frame or frameless patch fittings. Popular for kitchens, studies. Non-load-bearing.',
            cost: '$2560/sqm',
    ...
    'Plastering & Skim Coat': [
        {
            ...
            description: 'Traditional cement-sand mix (1:3 or 1:4 ratio) applied to brick/block walls in 1220mm thickness. Creates flat base for painting. Requires skilled plasterer.',
            cost: '$48/sqm',
        ...
        {
            name: 'Skim Coat (23mm)',
            description: 'Thin polymer-modified plaster (23mm) applied over existing walls or ceilings to create a smooth, paint-ready surface. Used on new gypsum board, concrete, or old painted walls.',
            cost: '$24/sqm',
        ...
        },
        {
            ...
            description: 'Traditional cement-sand floor screed (2050mm) to level and raise floor. Multiple grades for drainage fall in wet areas. Needs 1428 day cure.',
            cost: '$48/sqm',
            pros: 'Can fix major level differences, creates drainage fall, proven method, affordable',
            cons: 'Long cure time (1428 days), heavy, wet trade, can crack if too thin',
            tier: 'standard',
        },
        {
    ...
    'Paint Types & Brands': [
        {
            ...
            cost: '$2545/5L tin, covers 5060sqm/coat',
        ...
        },
        {
            ...
            cost: '$60120/5L tin + specialist applicator',
        ...
        },
        {
            ...
            cost: '$5080/5L tin',
            pros: 'UV-resistant, waterproof, flexible (crack-resistant), 58 year lifespan, fade-resistant',
    ...
    'Surface Prep & Adhesives': [
        {
            ...
            cost: '$1535/25kg bag (covers 46sqm)',
        ...
        },
        {
            ...
            cost: '$2550/25kg bag (covers 34sqm)',
        ...
        },
        {
            ...
            description: 'Cement grout: standard, $815/kg. Epoxy grout (Mapei Kerapoxy, Laticrete Spectralock): stain-proof, waterproof, $3060/kg. Epoxy for wet areas and light-coloured grout.',
            cost: '$815/kg (cement), $3060/kg (epoxy)',
        ...
        },
        {
            ...
            description: 'Full wall prep Roof: hack existing finish  apply bonding agent  plaster/skim coat  sand smooth  prime  paint. Each step affects final quality.',
            cost: '$818/sqm (full hack-to-paint)',
    ...
    'Scaffolding': [
        ...
        },
        {
            ...
            cost: '$200500/day (rental + operator)',
        ...
        },
        {
            ...
            cost: '$2080 (purchase) or included in contractor quote',
    ...
    'Lighting': [
        ...
        },
        {
            ...
            cost: '$1560/unit (supply), $2040/point (install)',
        ...
        },
        {
            ...
            cost: '$80250/track set (1.5m + 3 heads)',
        ...
        },
        {
            ...
            cost: '$50500+/unit (design-dependent)',
        ...
        },
        {
            ...
            cost: '$200800/unit (fan + installation)',
